...
export function NxtAIValuationWizard() {
  // Wizard state
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <button
              ...
              className={
                ...
                (track === "operational"
                  ? "relative border-amber-400/60 ring-2 ring-amber-400/20 bg-amber-50/30 shadow-sm cursor-pointer"
                  : "border-slate-200 hover:border-slate-300 hover:bg-slate-50 hover:shadow-sm cursor-pointer")
              }
            >
    ...
    >
            ...
            <div className="flex flex-col items-center">
              <div
                className={
                  ...
                  (i === step
                    ? "text-slate-900 bg-amber-100 border-amber-400/60 ring-2 ring-amber-400/20 font-bold shadow-sm"
                    : "bg-slate-200 text-slate-400 font-semibold opacity-80")
                }
              >
                {i + 1}
              </div>
              <div
                className={
                  "text-xs mt-1 w-20 text-center transition-all " +
                  (i === step ? "text-slate-900 font-semibold" : "text-slate-400 opacity-80")
                }
              >
                {label}
              </div>
      ...
      {step < 4 && (
        <div className="flex justify-between mt-2">
          ...
          <button
            type="submit"
            className="ml-auto rounded-lg bg-amber-500 hover:bg-amber-600 text-slate-900 font-semibold px-6 py-2.5 focus-visible:ring-2 focus-visible:ring-amber-400/40 transition disabled:opacity-50 disabled:cursor-not-allowed"
